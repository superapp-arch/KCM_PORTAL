...
export interface MileageReport {
  ...
  // auto = dieselAmount + (extraFuel * ratePerLitreNew) - always, regardless
  // of extraFuelPaymentMode (2026-09-19 correction - see that field's own
...
export type DriverLocationCategory =
  ...
  | 'KCM Service Station'
  | 'ECOM F&V'
  // 2026-09-08 direct request - two new locations under Driver Details ->
  // Driver Salary.
  | 'Chennai'
  | 'Attibele'
